...
<div class="card">
								...
								<div class="card-header">
								    <div class="card-head-row">
									    <h4 class="card-title mt-3">Add Category
									    ...
									    <div class="card-tools">
											<ul class="nav nav-pills nav-secondary nav-pills-no-bd " role="tablist">
											    <li class="nav-item">
										            <a class="nav-link active" style="background: #28a745;!important;border-radius: 50px !important;;" href="{{url('add-new-category')}}"> <i class="fa fa-plus"></i>&nbsp; Add New Category</a>
</li>
											</ul>
										</div>
									</div>
...
<option value="app_id">Category ID</option>
<option value="app_name">Category Name</option>
</select>
                                                  </div>
                                                  <div class="form-group col-md-3">
...
<option value="150">150</option>
                        		        ...
                        		        <div class="d-flex align-items-center">
                        		            ...
                        		            <h4 class="card-title"> Total Category : <?php $count = DB::table('app_name')->count(); echo $count; ?> </h4>
							        ...
							        <div class="table-responsive">
										<table id="feedback_list_table" class="display table table-striped table-hover table-bordered ">
											...
											@foreach($selects as $select)
                                                            ...
                                                            <td>{{$select->language_name}}</td>
                                                            <td style="white-space: normal;" class="cat_list_box">{{$select->category_name}}</td>
															<td>{{$select->categoryaudioUploadType}}</td>
															<td>{{$select->category_audio}}</td>
															<td>{{$select->categoryImageUploadType}}</td>
															<td>{{$select->category_img}}</td>
                                                        
                                                            <td class="text-center">
                                                                                        									    <div class="form-button-action">
                                            					
                                            		     	   
                                            					<button type="button" onclick="doActionFn('edit','3');" data-toggle="tooltip" title="" class="btn btn-white text-primary" data-original-title="Edit">
                                            						<i class="fas fa-pencil-alt "></i>
                                            					</button>
                                            					
                                            					<button type="button" onclick="doActionFn('delete','3');" data-toggle="tooltip" title="" class="btn btn-white text-danger delbtn" data-original-title="Delete">
                                            						<i class="fas fa-trash "></i>
                                            					</button>
                                            					
                                            				</div>
    									                    </td>
                                                            <td>{{$select->create_at}}</td>
